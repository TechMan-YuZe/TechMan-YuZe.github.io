...
![输入图片说明](images/QQ截图20210924135855.png "QQ截图20201229183512.png")
...
![输入图片说明](images/QQ截图20210924140833.png "QQ截图20201229183512.png")

![输入图片说明](images/QQ截图20210924140847.png "QQ截图20201229183512.png")

![输入图片说明](images/QQ截图20210924140901.png "QQ截图20201229183512.png")
...
* AP - 满足可用性，分区容忍性的系统，通常可能对一致性要求低一些。
  ...
  ![输入图片说明](images/QQ截图20210924144835.png "QQ截图20201229183512.png")
...
![输入图片说明](images/QQ截图20210927092233.png "QQ截图20201229183512.png")
...
![输入图片说明](images/QQ截图20210927092451.png "QQ截图20201229183512.png")
...
![输入图片说明](images/QQ截图20210927112511.png "QQ截图20201229183512.png")
...
![输入图片说明](images/QQ截图20210927113113.png "QQ截图20201229183512.png")

下图展示了频道 channel1 ， 以及订阅这个频道的三个客户端 —— client2 、 client5 和 client1 之间的

![输入图片说明](images/QQ截图20210927113126.png "QQ截图20201229183512.png")

当有新消息通过 PUBLISH 命令发送给频道 channel1 时， 这个消息就会被发送给订阅它的三个客户端：

![输入图片说明](images/QQ截图20210927113242.png "QQ截图20201229183512.png")

### 命令

这些命令被广泛用于构建即时通信应用，比如网络聊天室(chatroom)和实时广播、实时提醒等。

![输入图片说明](images/QQ截图20210927113307.png "QQ截图20201229183512.png")
...
![输入图片说明](images/QQ截图20210927113849.png "QQ截图20201229183512.png")
...
![输入图片说明](images/QQ截图20210927113948.png "QQ截图20201229183512.png")

* 1 、拷贝多个redis.conf 文件

  ![输入图片说明](images/QQ截图20210927114022.png "QQ截图20201229183512.png")
...
* 6 、Dump.rdb 名字 dbfilename dump6379.rdb , 依次类推
  ...
  ![输入图片说明](images/QQ截图20210927114130.png "QQ截图20201229183512.png")

### 上面都配置完毕后， 3 个服务通过 3 个不同的配置文件开启，我们的准备环境就OK 了！

![输入图片说明](images/QQ截图20210927114141.png "QQ截图20201229183512.png")
...
* 1 、环境初始化
  ...
  ![输入图片说明](images/QQ截图20210928085838.png "QQ截图20201229183512.png")

默认三个都是Master 主节点

![输入图片说明](images/QQ截图20210928085902.png "QQ截图20201229183512.png")
...
* 3 、在主机设置值，在从机都可以取到！从机不能写值！
  ...
  ![输入图片说明](images/QQ截图20210928085936.png "QQ截图20201229183512.png")
...
![输入图片说明](images/QQ截图20210928090032.png "QQ截图20201229183512.png")
...
![输入图片说明](images/QQ截图20210928090112.png "QQ截图20201229183512.png")
...
![输入图片说明](images/QQ截图20210928090249.png "QQ截图20201229183512.png")
...
![输入图片说明](images/QQ截图20210928090331.png "QQ截图20201229183512.png")
...
![输入图片说明](images/QQ截图20210928090903.png "QQ截图20201229183512.png")

### 缓存空对象

> 当存储层不命中后，即使返回的空对象也将其缓存起来，同时会设置一个过期时间，之后再访问这个数据将会从缓存中获取，保护了后端数据源；

![输入图片说明](images/QQ截图20210928090930.png "QQ截图20201229183512.png")
...
![输入图片说明](images/QQ截图20210928091310.png "QQ截图20201229183512.png")
